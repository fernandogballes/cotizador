...
def standard_comunidades_provincias(df):
    with open('backend/Procesamiento/diccionario_comunidades_provincias.json', 'r') as file: comunidades_dict = json.load(file)
    with open('backend/Procesamiento/diccionario_estandar_comunidades.json', 'r') as file: estandar_dict = json.load(file)
