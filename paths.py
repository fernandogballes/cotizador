...
DDBB_MANTENIMIENTO_ACTIVIDADES_ACTUAL = DDBB_PATH + 'Mantenimiento/actividades_coberturas_actual.xlsx'
DDBB_MANTENIMIENTO_ACTIVIDADES_UPDATED = DDBB_PATH + 'Mantenimiento/actividades_coberturas_updated.xlsx'
